...
// Code is generated on: Thursday, January 02, 2014 6:47:12 PM
...
namespace Northwind.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public IPredicateExpression ConstructFilterForUCRegionDescription()
		{
			...
			filter.Add(new FieldCompareValuePredicate(this.Fields[(int)RegionFieldIndex.RegionDescription], null, ComparisonOperator.Equal));
 			return filter;
		}
