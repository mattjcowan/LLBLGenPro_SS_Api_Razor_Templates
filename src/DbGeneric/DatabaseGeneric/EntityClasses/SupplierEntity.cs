...
// Code is generated on: Thursday, January 02, 2014 6:47:13 PM
...
namespace Northwind.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public IPredicateExpression ConstructFilterForUCCompanyName()
		{
			...
			filter.Add(new FieldCompareValuePredicate(this.Fields[(int)SupplierFieldIndex.CompanyName], null, ComparisonOperator.Equal));
 			return filter;
		}
