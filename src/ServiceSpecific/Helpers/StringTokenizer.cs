...
namespace Northwind.Data.Helpers
{
    ...
    public class StringTokenizer
    {
        ...
        /// </summary>
        public char[] AdditionalWordChars
        {
            get { return this.additionalWordChars; }
            set { this.additionalWordChars = value; }
        }
        ...
        private void Reset()
        {
            ...
            this.additionalWordChars = new char[] {};
        ...
        ReadToken:
            ...
            switch (ch)
            {
                ...
                default:
                    {
                        if (Char.IsLetter(ch) || ch == '_' || additionalWordChars.Contains(ch))
                            return ReadWord();
                        else if (IsSymbol(ch))
                        {
                            StartRead();
