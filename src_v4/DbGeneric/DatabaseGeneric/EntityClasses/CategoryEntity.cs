...
// Code is generated on: Monday, June 24, 2013 12:10:19 PM
...
namespace Northwind.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public IPredicateExpression ConstructFilterForUCCategoryName()
		{
			IPredicateExpression filter = new PredicateExpression();
			filter.Add(Northwind.Data.HelperClasses.CategoryFields.CategoryName == this.Fields.GetCurrentValue((int)CategoryFieldIndex.CategoryName));
 			return filter;
		}
