...
// Code is generated on: Monday, June 24, 2013 12:10:21 PM
...
namespace Northwind.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		/// RegionDescription .</summary>
		/// <returns>true if succeeded and the contents is read, false otherwise</returns>
		public IPredicateExpression ConstructFilterForUCRegionDescription()
		{
			IPredicateExpression filter = new PredicateExpression();
			filter.Add(Northwind.Data.HelperClasses.RegionFields.RegionDescription == this.Fields.GetCurrentValue((int)RegionFieldIndex.RegionDescription));
 			return filter;
		}
