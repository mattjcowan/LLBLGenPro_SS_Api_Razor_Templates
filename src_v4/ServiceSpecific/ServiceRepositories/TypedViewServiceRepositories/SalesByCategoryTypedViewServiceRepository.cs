...
{ 
    public partial class SalesByCategoryTypedViewServiceRepository : TypedViewServiceRepositoryBase<SalesByCategory>, ISalesByCategoryTypedViewServiceRepository
	...
	// __LLBLGENPRO_USER_CODE_REGION_END 
    {
        ...
        public SalesByCategoryTypedViewServiceRepository()
        {
            OnCreateRepository();
        }

        // Description for parameters: http://datatables.net/usage/server-side
        public DataTableResponse GetDataTableResponse(SalesByCategoryDataTableRequest request)
        {
            ...
            var entities = Fetch(new SalesByCategoryQueryCollectionRequest
                {
                    Filter = filter, 
        ...
        public SalesByCategoryCollectionResponse Fetch(SalesByCategoryQueryCollectionRequest request)
        {
            ...
            var typedView = new SalesByCategoryTypedView();
            using (var adapter = DataAccessAdapterFactory.NewDataAccessAdapter())
            {
                OnBeforeFetchSalesByCategoryQueryCollectionRequest(adapter, request, sortExpression, includedFieldNames, predicateBucket,
                ...
                OnAfterFetchSalesByCategoryQueryCollectionRequest(adapter, request, typedView, sortExpression, includedFieldNames, predicateBucket,
                    request.PageNumber, request.PageSize, request.Limit, totalItemCount);
            }

            var dtos = new SalesByCategoryCollection();
            ...
            var response = new SalesByCategoryCollectionResponse(dtos, request.PageNumber,
