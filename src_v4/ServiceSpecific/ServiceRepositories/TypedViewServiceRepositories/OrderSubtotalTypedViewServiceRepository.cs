...
{ 
    public partial class OrderSubtotalTypedViewServiceRepository : TypedViewServiceRepositoryBase<OrderSubtotal>, IOrderSubtotalTypedViewServiceRepository
	// __LLBLGENPRO_USER_CODE_REGION_START SsSvcAdditionalInterfaces 
	// __LLBLGENPRO_USER_CODE_REGION_END 
    {
        #region Class Extensibility Methods
        partial void OnCreateRepository();
        partial void OnBeforeFetchOrderSubtotalQueryCollectionRequest(IDataAccessAdapter adapter, OrderSubtotalQueryCollectionRequest request, SortExpression sortExpression, string[] includedFieldNames, IRelationPredicateBucket predicateBucket, int pageNumber, int pageSize, int limit);
        partial void OnAfterFetchOrderSubtotalQueryCollectionRequest(IDataAccessAdapter adapter, OrderSubtotalQueryCollectionRequest request, OrderSubtotalTypedView typedView, SortExpression sortExpression, string[] includedFieldNames, IRelationPredicateBucket predicateBucket, int pageNumber, int pageSize, int limit, int totalItemCount);
        #endregion
        ...
        public OrderSubtotalTypedViewServiceRepository()
        {
            OnCreateRepository();
        }
        ...
        public DataTableResponse GetDataTableResponse(OrderSubtotalDataTableRequest request)
        {
            ...
            var entities = Fetch(new OrderSubtotalQueryCollectionRequest
                {
                    Filter = filter, 
        ...
        public OrderSubtotalCollectionResponse Fetch(OrderSubtotalQueryCollectionRequest request)
        {
            ...
            var typedView = new OrderSubtotalTypedView();
            using (var adapter = DataAccessAdapterFactory.NewDataAccessAdapter())
            {
                OnBeforeFetchOrderSubtotalQueryCollectionRequest(adapter, request, sortExpression, includedFieldNames, predicateBucket,
                ...
                OnAfterFetchOrderSubtotalQueryCollectionRequest(adapter, request, typedView, sortExpression, includedFieldNames, predicateBucket,
                    request.PageNumber, request.PageSize, request.Limit, totalItemCount);
            }

            var dtos = new OrderSubtotalCollection();
            ...
            var response = new OrderSubtotalCollectionResponse(dtos, request.PageNumber,
                                                          request.PageSize, totalItemCount);
            return response;       
        }

        private OrderSubtotal Map(OrderSubtotalRow row, string[] fieldNames)
        {
