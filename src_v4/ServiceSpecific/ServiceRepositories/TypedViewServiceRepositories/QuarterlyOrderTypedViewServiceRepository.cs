...
{ 
    public partial class QuarterlyOrderTypedViewServiceRepository : TypedViewServiceRepositoryBase<QuarterlyOrder>, IQuarterlyOrderTypedViewServiceRepository
	// __LLBLGENPRO_USER_CODE_REGION_START SsSvcAdditionalInterfaces 
	// __LLBLGENPRO_USER_CODE_REGION_END 
    {
        #region Class Extensibility Methods
        partial void OnCreateRepository();
        partial void OnBeforeFetchQuarterlyOrderQueryCollectionRequest(IDataAccessAdapter adapter, QuarterlyOrderQueryCollectionRequest request, SortExpression sortExpression, string[] includedFieldNames, IRelationPredicateBucket predicateBucket, int pageNumber, int pageSize, int limit);
        partial void OnAfterFetchQuarterlyOrderQueryCollectionRequest(IDataAccessAdapter adapter, QuarterlyOrderQueryCollectionRequest request, QuarterlyOrderTypedView typedView, SortExpression sortExpression, string[] includedFieldNames, IRelationPredicateBucket predicateBucket, int pageNumber, int pageSize, int limit, int totalItemCount);
        #endregion
        ...
        public QuarterlyOrderTypedViewServiceRepository()
        {
            OnCreateRepository();
        }

        // Description for parameters: http://datatables.net/usage/server-side
        public DataTableResponse GetDataTableResponse(QuarterlyOrderDataTableRequest request)
        {
            ...
            var entities = Fetch(new QuarterlyOrderQueryCollectionRequest
                {
                    Filter = filter, 
        ...
        public QuarterlyOrderCollectionResponse Fetch(QuarterlyOrderQueryCollectionRequest request)
        {
            ...
            var typedView = new QuarterlyOrderTypedView();
            using (var adapter = DataAccessAdapterFactory.NewDataAccessAdapter())
            {
                OnBeforeFetchQuarterlyOrderQueryCollectionRequest(adapter, request, sortExpression, includedFieldNames, predicateBucket,
                ...
                OnAfterFetchQuarterlyOrderQueryCollectionRequest(adapter, request, typedView, sortExpression, includedFieldNames, predicateBucket,
                    request.PageNumber, request.PageSize, request.Limit, totalItemCount);
            }

            var dtos = new QuarterlyOrderCollection();
            ...
            var response = new QuarterlyOrderCollectionResponse(dtos, request.PageNumber,
                                                          request.PageSize, totalItemCount);
            return response;       
        }

        private QuarterlyOrder Map(QuarterlyOrderRow row, string[] fieldNames)
        {
            var hasFn = fieldNames != null && fieldNames.Any();
            var item = new QuarterlyOrder();
