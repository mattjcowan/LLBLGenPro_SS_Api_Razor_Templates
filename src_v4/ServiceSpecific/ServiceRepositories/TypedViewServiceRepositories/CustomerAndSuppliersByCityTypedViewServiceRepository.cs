...
{ 
	...
	// __LLBLGENPRO_USER_CODE_REGION_END 
    {
        ...
        public CustomerAndSuppliersByCityTypedViewServiceRepository()
        {
            OnCreateRepository();
        }
        ...
        public DataTableResponse GetDataTableResponse(CustomerAndSuppliersByCityDataTableRequest request)
        {
            ...
            var entities = Fetch(new CustomerAndSuppliersByCityQueryCollectionRequest
                {
                    Filter = filter, 
        ...
        private CustomerAndSuppliersByCity Map(CustomerAndSuppliersByCityRow row, string[] fieldNames)
        {
