...
{ 
    public partial class ProductSalesFor1997TypedViewServiceRepository : TypedViewServiceRepositoryBase<ProductSalesFor1997>, IProductSalesFor1997TypedViewServiceRepository
	...
	// __LLBLGENPRO_USER_CODE_REGION_END 
    {
        ...
        public ProductSalesFor1997TypedViewServiceRepository()
        {
            OnCreateRepository();
        }

        // Description for parameters: http://datatables.net/usage/server-side
        public DataTableResponse GetDataTableResponse(ProductSalesFor1997DataTableRequest request)
        {
            ...
            var entities = Fetch(new ProductSalesFor1997QueryCollectionRequest
                {
                    Filter = filter, 
        ...
        private ProductSalesFor1997 Map(ProductSalesFor1997Row row, string[] fieldNames)
        {
            var hasFn = fieldNames != null && fieldNames.Any();
            var item = new ProductSalesFor1997();
