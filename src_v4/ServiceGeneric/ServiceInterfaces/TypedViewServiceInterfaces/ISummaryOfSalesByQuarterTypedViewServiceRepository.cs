...
{ 
    public interface ISummaryOfSalesByQuarterTypedViewServiceRepository: ITypedViewServiceRepository<SummaryOfSalesByQuarter>
	// __LLBLGENPRO_USER_CODE_REGION_START SsSvcAdditionalInterfaces 
	// __LLBLGENPRO_USER_CODE_REGION_END 
    {
        TypedViewMetaDetailsResponse GetTypedViewMetaDetails(ServiceStack.ServiceInterface.Service service);
        DataTableResponse GetDataTableResponse(SummaryOfSalesByQuarterDataTableRequest request);
        SummaryOfSalesByQuarterCollectionResponse Fetch(SummaryOfSalesByQuarterQueryCollectionRequest request);
