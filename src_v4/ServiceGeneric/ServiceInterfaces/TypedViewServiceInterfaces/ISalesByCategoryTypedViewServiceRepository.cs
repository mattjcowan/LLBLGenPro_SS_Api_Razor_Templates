...
{ 
    public interface ISalesByCategoryTypedViewServiceRepository: ITypedViewServiceRepository<SalesByCategory>
	// __LLBLGENPRO_USER_CODE_REGION_START SsSvcAdditionalInterfaces 
	// __LLBLGENPRO_USER_CODE_REGION_END 
    {
        TypedViewMetaDetailsResponse GetTypedViewMetaDetails(ServiceStack.ServiceInterface.Service service);
        DataTableResponse GetDataTableResponse(SalesByCategoryDataTableRequest request);
        SalesByCategoryCollectionResponse Fetch(SalesByCategoryQueryCollectionRequest request);
