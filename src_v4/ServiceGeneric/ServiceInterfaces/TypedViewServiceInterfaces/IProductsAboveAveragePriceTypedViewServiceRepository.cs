...
{ 
    public interface IProductsAboveAveragePriceTypedViewServiceRepository: ITypedViewServiceRepository<ProductsAboveAveragePrice>
	// __LLBLGENPRO_USER_CODE_REGION_START SsSvcAdditionalInterfaces 
	// __LLBLGENPRO_USER_CODE_REGION_END 

    {
        TypedViewMetaDetailsResponse GetTypedViewMetaDetails(ServiceStack.ServiceInterface.Service service);
        DataTableResponse GetDataTableResponse(ProductsAboveAveragePriceDataTableRequest request);
        ProductsAboveAveragePriceCollectionResponse Fetch(ProductsAboveAveragePriceQueryCollectionRequest request);
